/*****************************************************************************/
/**
 *  @file   myRayCastingRendererGLSL.cpp
 ...
 *
 *  $Id: myRayCastingRenderer.cpp 1476 2013-04-02 01:55:49Z naohisa.sakamoto@gmail.com $
 */
/*****************************************************************************/
...
/*===========================================================================*/
/**
 *  @brief  Constructs a new myRayCastingRenderer class.
 */
/*===========================================================================*/
myRayCastingRenderer::myRayCastingRenderer():
 ...
 */
/*===========================================================================*/
myRayCastingRenderer::myRayCastingRenderer( const kvs::TransferFunction& tfunc ):
    m_draw_front_face( true ),
    m_draw_back_face( true ),
    m_draw_volume( true ),
    m_enable_jittering( false ),
...
myRayCastingRenderer::myRayCastingRenderer( const ShadingType shader ):
    m_draw_front_face( true ),
    m_draw_back_face( true ),
    m_draw_volume( true ),
    m_enable_jittering( false ),
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::exec(
    ...
    kvs::Light* light )
{
    ...
    if ( m_draw_volume )
    {
        ...
        m_ray_casting_shader.bind();
        {
            ...
            kvs::Texture::Binder unit6( m_depth_texture, 5 );
            kvs::Texture::Binder unit7( m_color_texture, 6 );
            kvs::Texture::Binder unit8( m_alpha_texture, 7 );
            ...
            m_ray_casting_shader.setUniform( "alpha_data", 7 );
            this->draw_quad( 1.0f );
        }
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::setDrawingBuffer( const myRayCastingRenderer::DrawingBuffer drawing_buffer )
{
    ...
    {
    case myRayCastingRenderer::FrontFace: m_draw_front_face = true; break;
    case myRayCastingRenderer::BackFace: m_draw_back_face = true; break;
    case myRayCastingRenderer::Volume:
    {
        m_draw_front_face = true;
        m_draw_back_face = true;
        m_draw_volume = true;
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::setTransferFunction( const kvs::TransferFunction& tfunc )
{
     BaseClass::setTransferFunction( tfunc );
 ...
 */
/*==========================================================================*/
void myRayCastingRenderer::initialize_shader( const kvs::StructuredVolumeObject* volume )
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::initialize_jittering_texture()
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::initialize_bounding_cube_buffer( const kvs::StructuredVolumeObject* volume )
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::initialize_transfer_function_texture()
{
...
void myRayCastingRenderer::setAlphaTexture(const int x, const int y, const int z, const kvs::ValueArray<kvs::Real32>* volume)
{
    m_alpha_texture.release();
    m_alpha_texture.setWrapS( GL_CLAMP_TO_BORDER );
    m_alpha_texture.setWrapT( GL_CLAMP_TO_BORDER );
    m_alpha_texture.setWrapR( GL_CLAMP_TO_BORDER );
    m_alpha_texture.setMagFilter( GL_LINEAR );
    m_alpha_texture.setMinFilter( GL_LINEAR );
    m_alpha_texture.setPixelFormat( GL_ALPHA, GL_ALPHA, GL_FLOAT  );
    m_alpha_texture.create(x, y, z , volume->data() );
}
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::initialize_volume_texture( const kvs::StructuredVolumeObject* volume )
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::initialize_framebuffer( const size_t width, const size_t height )
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::update_framebuffer( const size_t width, const size_t height )
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::draw_bounding_cube_buffer()
{
 ...
 */
/*===========================================================================*/
void myRayCastingRenderer::draw_quad( const float opacity )
{
