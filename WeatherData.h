...
public:
  ...
  static int loadWeatherData(std::string filename, Parameter p, kvs::StructuredVolumeObject &vol);
...
private:
  ...
  static void loadVolume(std::ifstream &ifs, const int size, kvs::StructuredVolumeObject &vol);
