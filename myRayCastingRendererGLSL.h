/*****************************************************************************/
/**
 *  @file   myRayCastingRendererGLSL.h
 ...
 *
 *  $Id: myRayCastingRenderer.h 1472 2013-04-01 09:59:41Z naohisa.sakamoto@gmail.com $
 */
/*****************************************************************************/
#pragma once
#include <kvs/Module>
...
/*===========================================================================*/
/**
 *  @brief  myRayCastingRenderer class.
 */
/*===========================================================================*/
class myRayCastingRenderer : public kvs::VolumeRendererBase
{
    kvsModule( kvs::glsl::myRayCastingRenderer, Renderer );
...
private:
    ...
    kvs::Texture3D m_alpha_texture; ///< volume data (3D texture)
...
public:
    myRayCastingRenderer();
    myRayCastingRenderer( const kvs::TransferFunction& tfunc );
    template <typename ShadingType>
    myRayCastingRenderer( const ShadingType shader );
    ...
    void setAlphaTexture(const int x, const int y, const int z, const kvs::ValueArray<Real32>* volume);
